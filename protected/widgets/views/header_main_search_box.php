...
?>
    ...
    <?php 
		...
		echo $form->textField($model, 'search_keyword', array('id' => 'search_keyword', "class" => "searchBox searchBoxcity", "data-noval" => "Entrez un nom de ville, de département, de restaurant ou un point d'intérêt",  'value'=>"$srchBoxInptValue", 'onfocus'=>"this.value='';", 'onblur'=>"if(this.value==''){this.value='$srchBoxInptValue';}")); ?>
	...
	<?php echo $form->hiddenField($model, 'latitude', array('id' => 'latitude')); ?>
        ...
        <input type="button" class="srchGeoLocation">
