                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td height=""  valign="middle" align="left" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'">
                                        Your BTC transaction was successful. The details are provided below.
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <table width="100%" cellspacing="0" cellpadding="0" border="1">
                                            <tbody>
                                                ...
                                                <?php if (!empty($walletPostArr['fromUserName'])) { ?>
                                                    <tr>
                                                ...
                                                <?php } ?>
                                                <tr>
                                                    <th width="50%" align="center" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'">Transfer From(Wallet) : </th>
                                                    <th width="50%" align="center" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'"><?php echo $walletPostArr['fromUserWallet']; ?></th>
                                                </tr>
                                                <tr>
                                                    <th width="50%" align="center" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'">Transfer To : </th>
                                                    <th width="50%" align="center" style="line-height:22px; color: #6b6b6b; font-size:16px; font-family:'Nunito'"><?php echo $walletPostArr['toUserWallet']; ?></th>
                                                </tr>
                                                <tr>
