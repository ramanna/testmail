                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td height=""  valign="middle" align="left" style="line-height:22px; color: #00BDAE; font-size:16px; margin-left:10px;font-family:'Nunito'">
                                                        Thank you for submitting your order for Exchange from <?php echo isset($sourceCurrencyName) ? $sourceCurrencyName : ""; ?>   to   <?php echo isset($destinationCurrencyName) ? $destinationCurrencyName : ""; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="5"  >
                                                ...
                                                <tr>
                                                    <td height=""  valign="middle" align="c" style="line-height:22px; color: #6b6b6b; font-size:14px; font-family:'Nunito'">
                                                         Please keep us updated when you have transferred the mentioned amount from <?php echo isset($sourceCurrencyName) ? $sourceCurrencyName : ""; ?> as per the instruction below. Once this is done we will make the transfer to your account.
                                                    </td>
                                                </tr>
                                                <tr>
